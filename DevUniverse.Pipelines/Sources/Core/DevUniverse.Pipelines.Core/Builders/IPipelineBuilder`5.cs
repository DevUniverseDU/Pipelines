...
namespace DevUniverse.Pipelines.Core.Builders
{
    ...
    public interface IPipelineBuilder<T0, T1, T2, T3, TResult> : IPipelineBuilder
    {
        #region Properties
        ...
        public IPipelineBuilder<T0, T1, T2, T3, TResult> Use(Func<Func<T0, T1, T2, T3, TResult>, Func<T0, T1, T2, T3, TResult>> component);
        ...
        /// <returns>The current instance of the pipeline builder.</returns>
        public IPipelineBuilder<T0, T1, T2, T3, TResult> Use(Func<T0, T1, T2, T3, Func<T0, T1, T2, T3, TResult>, TResult> handler);
        ...
        /// <returns>The current instance of the pipeline builder.</returns>
        public IPipelineBuilder<T0, T1, T2, T3, TResult> Use<TPipelineStep>() where TPipelineStep : IPipelineStep<T0, T1, T2, T3, TResult>;
        ...
        /// <returns>The current instance of the pipeline builder.</returns>
        public IPipelineBuilder<T0, T1, T2, T3, TResult> Use(Func<IPipelineStep<T0, T1, T2, T3, TResult>> factory);
        ...
        /// <param name="factory">The factory which provides the pipeline step instance.</param>
        /// <returns>The current instance of the pipeline builder.</returns>
        public IPipelineBuilder<T0, T1, T2, T3, TResult> Use(Func<IServiceProvider, IPipelineStep<T0, T1, T2, T3, TResult>> factory);
        ...
        /// <returns>The current instance of the pipeline builder.</returns>
        public IPipelineBuilder<T0, T1, T2, T3, TResult> UseIf
        (
        ...
        /// <param name="configuration">The configuration of the branch pipeline builder.</param>
        /// <returns>The current instance of the pipeline builder.</returns>
        public IPipelineBuilder<T0, T1, T2, T3, TResult> UseBranchIf
        (
            Func<T0, T1, T2, T3, bool> predicate,
            Action<IPipelineBuilder<T0, T1, T2, T3, TResult>> configuration
        );
        ...
        /// <returns>The current instance of the pipeline builder.</returns>
        public IPipelineBuilder<T0, T1, T2, T3, TResult> UseTarget(Func<T0, T1, T2, T3, TResult> target);
        ...
        public Func<T0, T1, T2, T3, TResult> Build();
        ...
        public IPipelineBuilder<T0, T1, T2, T3, TResult> Copy();
