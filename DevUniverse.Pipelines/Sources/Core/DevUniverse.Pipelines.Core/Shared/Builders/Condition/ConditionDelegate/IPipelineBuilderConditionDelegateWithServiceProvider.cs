...
namespace DevUniverse.Pipelines.Core.Shared.Builders.Condition.ConditionDelegate
{
    /// <summary>
    ...
    public interface IPipelineBuilderConditionDelegateWithServiceProvider<TDelegate, in TPredicate, TResult> :
        IPipelineBuilderWithServiceProvider<TDelegate, TResult>
        where TDelegate : Delegate
        where TPredicate : Delegate
        where TResult : IPipelineBuilderConditionDelegateWithServiceProvider<TDelegate, TPredicate, TResult>
    {
        /// <summary>
