...
namespace DevUniverse.Pipelines.Core.Steps
{
    ...
    public interface IPipelineStep<T0, T1, T2, T3, TResult> : IPipelineStep
    {
        /// <summary>
        ...
        public TResult Invoke(T0 param0, T1 param1, T2 param2, T3 param3, Func<T0, T1, T2, T3, TResult> next);
    }
}
