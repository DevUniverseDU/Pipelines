...
namespace DevUniverse.Pipelines.Core.Conditions
{
    ...
    public interface IPipelineConditionAsync<in TParam0, in TParam1, in TParam2, in TParam3> : IPipelineConditionAsyncBasic
    {
        /// <summary>
        ...
        public Task<bool> InvokeAsync(TParam0 param0, TParam1 param1, TParam2 param2, TParam3 param3);
    }
}
